...
//#line 210 "gramatica.y"
{
					...
					if(val_peek(1).ival<=0){/*$3 no hace referencia a un identificador*/
						...
						if((tablaSimbolo.obtenerToken(val_peek(1).ival).getUso()!="funcion") && (tablaSimbolo.obtenerToken(val_peek(1).ival).getUso()!="funcion designada a variable")){
							...
							if(tablaSimbolo.obtenerToken(val_peek(1).ival).getUso()=="funcion")
								tablaSimbolo.obtenerToken(val_peek(3).ival).setFuncionReferenciada(tablaSimbolo.obtenerValor(val_peek(1).ival));
							else
								tablaSimbolo.obtenerToken(val_peek(3).ival).setFuncionReferenciada(tablaSimbolo.obtenerToken(val_peek(1).ival).getFuncionReferenciada());
						}
					}
		       ...
		       if(tablaSimbolo.obtenerToken(val_peek(3).ival).getUso()!="funcion designada a variable")
